...
const Register = () => {
  ...
  return (
    <div className="h-screen bg-background flex justify-center items-center font-poppins">
      <div className="bg-background-light p-10 rounded-lg shadow-lg w-full max-w-sm">
        <h2 className="text-2xl font-bold text-primary text-center mb-6">
          Register To SoundWave
        </h2>
        <form className="mt-8" onSubmit={submitHandler}>
          ...
          <button disabled={btnLoading} className="w-full p-3 mt-4 rounded-md bg-accent text-primary font-bold hover:bg-blue-700 transition-colors disabled:opacity-50">
